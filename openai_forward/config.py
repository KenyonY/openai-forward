...
def print_startup_info(base_url, route_prefix, api_key, forward_key, log_chat):
    ...
    table.add_column("openai-api-key", justify="center", style="blue")
    table.add_column("forward-key", justify="center", style="blue")
    table.add_column("Log-chat", justify="center", style="blue")
